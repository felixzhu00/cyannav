            ...
            >
                ...
                <FormControl variant="outlined" sx={{ ml: 2 }}>
                    <Select
                        ...
                        sx={{ height: "50px" }}
                    >
                        <MenuItem id="byMapNameBtn" value="mapName">
                            Map Name
                        </MenuItem>
            ...
            >
                ...
                <FormControl variant="outlined" sx={{ width: 200 }}>
                    <Select
                        ...
                        sx={{ height: "50px" }}
                    >
                        <MenuItem id="recentSortSelect" value="recent">
                            Recently Created
                        </MenuItem>
                        <MenuItem
                            id="nameSortSelect"
                        ...
                        <MenuItem id="mostLikedSortSelect" value="most-liked">
                            Most Liked
                        </MenuItem>
                        <MenuItem
                            id="mostDislikedSortSelect"
                            value="most-disliked"
                        >
                            Most Disliked
                        </MenuItem>
    ...
    return (
        ...
        >
            ...
            <Typography variant="h4" sx={{ fontWeight: "bold" }}>
                {store.togglebrowseHome && auth.loggedIn
                    ? "My Maps"
                    : "Marketplace"}
            </Typography>
            <Box sx={{ mt: "10px" }}>{searchAndSort()}</Box>

            {auth.loggedIn && store.togglebrowseHome && (
                <Button
